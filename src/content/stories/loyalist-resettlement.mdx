...
<figure style="display: block;margin-left: auto;margin-right: auto;width: 75%;">
  <a href="/maps/commonwealth:hx11z4831">
   <img src="https://iiif.digitalcommonwealth.org/iiif/2/commonwealth:hx11z4849/365,273,8293,4994/pct:50/0/default.jpg" alt="The map A Plan of the Town of St. Andrews (1785), in which the city blocks are laid out in a grid structure, with empty gaps between some blocks for public areas. Also shown is the coastline surrounding the city." />
  </a>
  <figcaption>
...
Banner image credit: [Benjamin West’s Reception of the American Loyalists by Great Britain in the Year 1783](https://upload.wikimedia.org/wikipedia/commons/3/37/Reception_of_the_American_Loyalists.jpg)
