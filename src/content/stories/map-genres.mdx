...
<p>
The individual items in the portal encompass a wide range of map scales showing varying levels of detail. They range from small scale depictions (showing a small amount of detail, usually for a large geographic area) to large scale \(showing a large amount of detail for much smaller geographic areas\).[^2] 
<p>
## Military Maps
The most obvious types of maps found in late eighteenth and early nineteenth century cartography are those relating to military activity. There are three generally accepted categories of military maps: intelligence gathering and operational maps, campaign and battle maps, and fortification plans and maps \(Brown 2020, Ehrenberg and Morgan 2020, Harley 1978, Hodson 2019\).
...
<CollectionGrid
    title="Examples of Intelligence Gathering and Operational Maps"
    contentType="maps"
    columns={2}
    identifiers={[
...
<CollectionGrid
    title="Example of Campaign and Battle Maps"
    contentType="maps"
    columns={1}
    identifiers={[
...
<CollectionGrid
    title="Example of Fortification Maps"
    contentType="maps"
    columns={1}
    identifiers={[
...
<CollectionGrid
    title="Examples of Maps of Empire"
    contentType="maps"
    columns={2}
    identifiers={[
...
<CollectionGrid
    title="Example of Nautical Charts"
    contentType="maps"
    columns={1}
    identifiers={[
...
<CollectionGrid
    title="Example of Town Plans and Maps"
    contentType="maps"
    columns={1}
    identifiers={[
...
<CollectionGrid
    title="Example of Property Surveys"
    contentType="maps"
    columns={1}
    identifiers={[
...
<CollectionGrid
    title="Example of Journalistic and Educational Maps"
    contentType="maps"
    columns={2}
    identifiers={[
...
<CollectionGrid
    title="Examples of Thematic and Pictorial Maps"
    contentType="maps"
    columns={2}
    identifiers={[
...
<CollectionGrid
    title="Examples of Landscape Views"
    contentType="maps"
    columns={2}
    identifiers={[
